...
class VectorDatabase:
    ...
    def _maybe_upgrade_index(self):
        ...
        # Upgrade strategy
        if n >= 10000 and not isinstance(self.index, faiss.IndexIVFFlat):
            logger.info("Upgrading to IndexIVFFlat for large dataset")
            self._upgrade_to_ivf()
        elif n >= 1000 and not isinstance(self.index, faiss.IndexHNSWFlat):
    ...
    def _upgrade_to_ivf(self):
        ...
        new_index.nprobe = 10  # Number of clusters to search
