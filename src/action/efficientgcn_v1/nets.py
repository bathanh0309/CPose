...
from .layers import Spatial_Graph_Layer, Temporal_Basic_Layer, Temporal_Sep_Layer, Temporal_Bottleneck_Layer, Temporal_SG_Layer
...
class EfficientGCN_Blocks(nn.Sequential):
    def __init__(self, init_channel, block_args, layer_type, kernel_size, input_channel=0, **kwargs):
        ...
        temporal_layers = {
            "Basic": Temporal_Basic_Layer,
            "Sep": Temporal_Sep_Layer,
            "Bottleneck": Temporal_Bottleneck_Layer,
            "SG": Temporal_SG_Layer,
        }
        temporal_layer = temporal_layers[layer_type]
