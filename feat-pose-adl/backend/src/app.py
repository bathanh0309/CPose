"""
HAVEN Web Server
FastAPI backend for Web UI: Pose + ADL + Live Stream Dashboard
"""
import sys
import threading
...
async def shutdown_event():
    """Ensure runner gets cleaned up and metrics/logs are safely saved when server exits."""
...
async def get_status():
    ...
    global runner
    if runner:
        return JSONResponse(content=runner.get_status())
