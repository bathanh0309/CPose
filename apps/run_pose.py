...
def main():
    ...
    source = args.source or get_module_source(cfg, "pose") or find_default_video_source(ROOT)
    if source is None:
        raise RuntimeError("No video source found. Set sources.pose or pass --source.")
