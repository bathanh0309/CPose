...
│  │  phase1_recorder │  (IDLE → ARMED → RECORDING → POST_ROLL)       │
│  └────────┬─────────┘                                               │
│           │ raw_videos/*.mp4                                        │
│           ▼                                                         │
│  ┌──────────────────┐                                               │
│  │  PHASE 2         │  YOLOv11n → BBox → PNG frame + labels.txt     │
│  │  phase2_analyzer │  (offline batch processing)                   │
│  └────────┬─────────┘                                               │
│           │ output_labels/<stem>/                                   │
│           ▼                                                         │
│  ┌──────────────────────────────────────────────────────────────┐   │
│  │  PHASE 3 — Pose + ADL                                        │   │
│  │  phase3_recognizer + pose_utils                              │   │
│  │                                                              │   │
...
**File:** `app/services/phase1_recorder.py`
...
**File:** `app/services/phase2_analyzer.py`
...
**Files:** `app/services/phase3_recognizer.py`, `app/utils/pose_utils.py`
