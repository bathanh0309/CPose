...
from src.visualization import draw_adl_label, draw_skeleton
from models.adl_recognition.metrics import build_adl_metrics
...
def process_video(
    ...
    for record in pose_records:
        for person_idx, person in enumerate(record.get("persons", [])):
...
def process_folder(
    ...
    from src.logging_utils import print_video_progress
