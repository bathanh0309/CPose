...
> Đây là tài liệu ràng buộc bắt buộc cho Codex / Codex / Copilot khi làm việc với **CPose**.
...
# AGENTS.md — CPose Project Binding Reference
...
QUY ĐỊNH CHO LLM (Codex / Copilot / Codex):
...
- Danh sách bug trong `PIPELINE.md` hỗ trợ giải thích, nhưng thứ tự ưu tiên sửa bug vẫn theo mục 17 của `AGENTS.md`.
...
app/core/adl.py: không dùng trong runtime (đã khóa ở AGENTS.md).
...
Nếu tài liệu cũ hoặc code hiện tại mâu thuẫn với AGENTS.md, ưu tiên AGENTS.md, trừ khi user nói rõ là muốn đổi luật.
