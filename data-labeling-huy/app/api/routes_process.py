...
# 
@router.get("/get/{video_name}/frames/{image_name}", summary="Send Full Frame Images to user device")
async def get_frame_image(video_name: str, image_name: str):
    image_path = OUTPUT_DIR / video_name / "frames" / image_name
